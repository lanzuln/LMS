                                                ...
                                                <ul class="cart-dropdown-menu after-none">
                                                    <li class="media media-card">
                                                        <a href="lesson-details.html" class="media-img">
                                                            <img class="mr-3"
                                                                src="{{ asset('frontend/assets/images/small-img-3.jpg') }}"
                                                    ...
                                                    <li class="media media-card">
                                                        <a href="lesson-details.html" class="media-img">
                                                            <img class="mr-3"
                                                                src="{{ asset('frontend/assets/images/small-img-4.jpg') }}"
                                                                alt="Course thumbnail image">
                                                        </a>
                                                        <div class="media-body">
                                                            <h5><a href="lesson-details.html">The Complete JavaScript
                                                ...
                                                <ul class="cart-dropdown-menu after-none">
                                                    <li class="media media-card">
                                                        <a href="shopping-cart.html" class="media-img">
                                                            <img class="mr-3"
                                                                src="{{ asset('frontend/assets/images/small-img.jpg') }}"
                                                                alt="Cart image">
                                                        </a>
                                                        <div class="media-body">
                                                ...
                                                <div class="shop-cart-btn">
                                                    <div class="avatar-xs">
                                                        <img class="rounded-full img-fluid"
                                                            src="{{ asset($profile_data->photo ?? 'no_image.png') }}"
                                                            alt="Avatar image">
                                                    </div>
                                                    <span class="dot-status bg-1"></span>
                                                </div>
                                                    ...
                                                    <li class="menu-heading-block d-flex align-items-center">
                                                        ...
                                                        <div class="ml-2">
                                                            <h4><a href="teacher-detail.html"
                                                                    class="text-black">{{ $profile_data->name }}</a>
                                                            </h4>
                                                            <span
                                                                class="d-block fs-14 lh-20">{{ $profile_data->email }}</span>
                                                        </div>
                                                    </li>
                                                    <li>
                                                        <div
