                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-column align-items-center text-center">
                                    <img src="{{ asset($profileData->photo ?? 'no_image.png') }}" alt="Admin"
                                        class="rounded-circle p-1 bg-primary" width="110" height="110px" style="object-fit:cover">
                                    <div class="mt-3">
                            ...
                            <form action="{{route('instructor.profile.update')}}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-9 text-secondary">
                                            <input type="submit" id="saveChangesBtn" class="btn btn-primary px-4" value="Save Changes">
                                        </div>
                                    </div>
                            </form>
                            </div>
