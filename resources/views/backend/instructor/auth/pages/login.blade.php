@extends('backend.admin.auth.layout.auth')
@section('body')
<div class="wrapper">
            ...
            <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                        ...
                        <div class="card-body">
                            <div class="p-4">
                                ...
                                <div class="text-center mb-4">
                                    <h5 class="">Login As Instructor</h5>
                ...
                <form class="row g-3" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="col-12">
                        ...
                        <input type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{old('email')}}" id="inputEmailAddress" placeholder="jhon@example.com">
                        @error('email')
